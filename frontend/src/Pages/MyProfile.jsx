  ...
  return (
    <>
        ...
        <div className='bg-white shadow-lg rounded-lg my-15 lg:mx-96 md:mx-40 sm:mx-20 p-8 grid grid-cols-3 gap-y-6 mb-10'>
                ...
                <label htmlFor="name" className=" block font-bold text-gray-600 ">Name
                </label>
                <span>:</span>
                ...
                <label htmlFor="id" className=" block font-bold text-gray-600 ">Date Of Birth
                </label>
                <span>:</span>
                ...
                <span>:</span>
                <span className=" ml-2">{userData?.contact}</span>
                


            
                <label htmlFor="dob" className=" block font-bold text-gray-600 ">Address
                </label>
                <span>:</span>
